...
public class OverdueMaintenanceFragment extends Fragment {
    ...
    private MaintenanceOverdueAdapter maintenanceOverdueAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_maintenance_overdue);
        ...
        if (getUserAssociatedEntity != null) {
            ...
            ApiInterface.retrofit.getallmaintenanceoverdue(Integer.parseInt(getUserAssociatedEntity),71).enqueue(new Callback<WebAPIResponse<List<MaintenanceOverdue>>>() {
                @Override
                    ...
                    if (response.isSuccessful()) {
                        try {
                            if (response.body().status) {
                                ...
                                maintenanceOverdueAdapter = new MaintenanceOverdueAdapter(maintenanceOverdues);
