...
public class MaintenanceDueAdapter extends RecyclerView.Adapter<MaintenanceDueAdapter.MyViewHolder> {

    public List<MaintenanceOverdue> maintenanceOverdues;
    public MaintenanceDueAdapter(List<MaintenanceOverdue> maintenanceOverdues)
    {
    ...
    @Override
    public MaintenanceDueAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_due_maintenance, parent, false);
        return new MaintenanceDueAdapter.MyViewHolder(view);
    }



    @Override
    public void onBindViewHolder(MaintenanceDueAdapter.MyViewHolder holder, int position) {
