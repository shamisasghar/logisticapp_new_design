...
public class MaintenanceCompleteAdapter extends RecyclerView.Adapter<MaintenanceCompleteAdapter.MyViewHolder> {

    public List<MaintenanceOverdue> maintenanceOverdues;
    public MaintenanceCompleteAdapter(List<MaintenanceOverdue> maintenanceOverdues)
    {
    ...
    @Override
    public MaintenanceCompleteAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_complete_miantenance, parent, false);
        return new MaintenanceCompleteAdapter.MyViewHolder(view);
    }



    @Override
    public void onBindViewHolder(MaintenanceCompleteAdapter.MyViewHolder holder, int position) {
